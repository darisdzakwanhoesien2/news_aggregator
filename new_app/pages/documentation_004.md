Let's have a options to input for several MCQ questions, or using the existing one, or uploading it at the end of it

The output will with the LLM is the JSON answer verification with the document with the reasoning, for example
