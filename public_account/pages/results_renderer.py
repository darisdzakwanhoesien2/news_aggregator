...
# def _safe_json_for_js(obj) -> str:
#     """
#     Return a JSON string safe to embed in a <script> block.
#     Escapes closing </ to avoid ending the script tag early.
#     """
#     s = json.dumps(obj, ensure_ascii=False)
#     return s.replace("</", "<\\/")

# def render_results_html(result_json: dict, height: int = 780):
#     """
#     Render a polished HTML view of verification results using a single self-contained
#     HTML+CSS+JS template embedded into Streamlit via components.html.

#     Usage:
#       from pages.components.results_renderer import render_results_html
#       render_results_html(j)
#     """
#     payload = _safe_json_for_js(result_json or {})
#     html_template = f"""
# <!doctype html>
